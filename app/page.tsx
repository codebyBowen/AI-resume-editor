          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            <div className="flex-1 space-y-6">
              ...
              <p className="text-xl text-slate-300 max-w-xl">
                Create professional, ATS-optimized resumes in seconds with our
                cutting-edge AI technology. Stand out from the competition and
                land your dream job.
              </p>
          ...
          <AnimatedSection>
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <p className="text-lg text-slate-600">
                ...
                professional resumes that get noticed by recruiters and pass
                through ATS systems.
              </p>
            </div>
          </AnimatedSection>
            ...
            <div className="flex-1 space-y-8">
              <AnimatedSection>
                ...
                <p className="text-lg text-slate-600 mb-8">
                  We combine cutting-edge AI technology with proven resume
                  strategies to give you the best chance of landing your dream
                  job.
                </p>
              </AnimatedSection>
                ...
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600">
                      Our AI is trained on millions of successful resumes and
                      hiring data to know exactly what works.
                    </p>
                  </div>
                </div>
              </AnimatedSection>
              ...
              <AnimatedSection delay={0.2}>
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600">
                      Create and customize professional resumes in minutes
              ...
              <AnimatedSection delay={0.3}>
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600">
                      Our AI understands the nuances of different industries and
                      tailors your resume accordingly.
                    </p>
                  </div>
                </div>
              </AnimatedSection>
              ...
              <AnimatedSection delay={0.4}>
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600">
                      Our AI learns from successful hires and continuously
        ...
        <div className="container mx-auto px-4">
          <AnimatedSection>
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <p className="text-lg text-slate-600">
                Thousands of professionals have landed their dream jobs with our
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <AnimatedSection delay={0.1}>
              <TestimonialCard
                ...
                image="/avatars/avatar5.png?height=80&width=80"
                rating={5}
            ...
            <AnimatedSection delay={0.2}>
              <TestimonialCard
                ...
                image="/avatars/avatar6.png?height=80&width=80"
                rating={5}
            ...
            <AnimatedSection delay={0.3}>
              <TestimonialCard
                ...
                image="/avatars/avatar7.png?height=80&width=80"
                rating={5}
